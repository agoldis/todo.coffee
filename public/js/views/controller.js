...
(function() {
  define(['backbone', 'underscore', 'models/item', 'views/status', 'constants', 'text!templates/control.html'], function(Backbone, _, ItemModel, StatusView, constants, controlTpl) {
