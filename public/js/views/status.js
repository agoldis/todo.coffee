...
(function() {
  define(['backbone', 'underscore', 'text!templates/status.html'], Backbone.View.extend({
    ...
    render: function() {
      ...
      this.renderCounters();
      this.$el.find('button').end().removeClass('active btn-info').find("#show-" + ($model.get('show'))).addClasss('active btn-info');
      this.delegateEvents();
      return this;
    }
  }));
